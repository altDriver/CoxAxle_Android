...
package coxaxle.cox.automotive.com.android.twothumbseekbar;
 ...
 */
public class RangeSeekBarwithSymbol<T extends Number> extends ImageView {
    /**
     * Default color of a {@link RangeSeekBarwithSymbol}, #FF33B5E5. This is also known as "Ice Cream Sandwich" blue.
     */
    ...
    public RangeSeekBarwithSymbol(Context context) {
        super(context);
        init(context, null);
    }

    public RangeSeekBarwithSymbol(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public RangeSeekBarwithSymbol(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected synchronized void onDraw(@NonNull Canvas canvas) {
        ...
        if (showLabels) {
            ...
            String minLabel = getContext().getString(R.string.demo_min_labl);
            String maxLabel = getContext().getString(R.string.demo_max_labl);
    ...
    public interface OnRangeSeekBarChangeListener<T extends Number> {
        ...
        void onRangeSeekBarValuesChanged(RangeSeekBarwithSymbol<T> bar, T minValue, T maxValue);
    }
