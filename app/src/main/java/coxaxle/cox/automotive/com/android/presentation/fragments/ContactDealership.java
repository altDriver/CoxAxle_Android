 ...
 */
public class ContactDealership extends Fragment {
    View view;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.contact_dealership_fragment,container,false);
        ((HomeScreenActivity) getActivity()).toolbar_title.setText("Contact Dealership");
